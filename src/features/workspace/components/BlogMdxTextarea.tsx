...
export const BlogMdxTextarea = ({
  ...
  return (
    <label className="grid gap-2 text-sm font-medium text-black" htmlFor="blog-mdx">
      <span>MDX</span>
      <textarea
        className="min-h-[560px] rounded-md border border-black/15 bg-white px-3 py-3 font-mono text-sm leading-6 text-black outline-none transition placeholder:text-black/45 focus:border-black"
        id="blog-mdx"
